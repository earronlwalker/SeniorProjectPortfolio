...
namespace StarterGame
{
    public class CommandWords
    {
        ...
        private static Command[] commandArray = { new GoCommand(), new LookCommand(), new BackCommand(), new InventoryCommand(), new ExamineCommand() , new PickUpCommand(), new DropCommand() , new QuitCommand()};
